...
// components
import { RoundChair } from '@/components/round_chair/component'
...
const RoundChairPage = () => {
    ...
    const getSeatingColor = ()=> {
        return configOptions.find(c=> c.title === SeatingColor)!.selectedColor
    }
            ...
            <Canvas shadows camera={{ position: [5, 0, 15], fov: 30 }} style={{ width: '100vw', height: '100vh' }}>
                ...
                <group position={[ 0, 1, -9 ]}>
                    <Text
                        ...
                        position={ isMobile ? [ 0, 2.5, -4 ] : [ -2, 0, -4 ] }
                    >
                        Round Chair
